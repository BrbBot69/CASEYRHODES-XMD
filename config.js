...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Caseyrhodes~wGcTBTzR#8prju19lsSxs1fbzlHd9DcUDDApubUCcS-R8HT7xvPE",
// add your Session Id 
PREFIX: process.env.PREFIX || ".",
// add your prifix for bot
BOT_NAME: process.env.BOT_NAME || "✦ 𝕬𝖛𝖊.𝕭☚⍢⃝☚ ✦ XMD ✦",
...
OWNER_NAME: process.env.OWNER_NAME || "✦ 𝕬𝖛𝖊.𝕭 ✦ XMD ✦",
// add bot owner name
...
AUTO_STATUS__MSG: process.env.AUTO_STATUS__MSG || "*🎉👀 Seen by 𝕬𝖛𝖊.𝕭☚⍢⃝☚ XMD 🚀🔥*",
